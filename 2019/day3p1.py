        ...
        for i in range(len(self.grid)):
            if self.grid[i][0] == pt:
                if self.grid[i][1] == wire:
                    ...
                    return 0
        self.grid.append([pt, wire])
        return 0
            
grid = Grid()

def testWire(wire, wirename):
    print(wirename)
    ...
    for i in wire:
        ...
        l = int(i[1:])
        if d == 'U':
            x0, x1, y0, y1, step = current_x, current_x + 1, current_y + 1, current_y + l + 1, 1
            current_y = current_y + l
        elif d == 'D':
            x0, x1, y0, y1, step = current_x, current_x - 1, current_y - 1, current_y - l - 1, -1
            current_y = current_y - l
        elif d == 'R':
            x0, x1, y0, y1, step = current_x + 1, current_x + l + 1, current_y, current_y + 1, 1
